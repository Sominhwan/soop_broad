...
class CustomThemeData {
  ...
  static final ThemeData light = ThemeData(
    ...
    tabBarTheme: TabBarTheme(
      ...
      labelColor: const Color.fromRGBO(27, 83, 243, 1),
      splashFactory: NoSplash.splashFactory,
      dividerColor: Colors.transparent,
      indicatorSize: TabBarIndicatorSize.tab,
      overlayColor: WidgetStatePropertyAll(Colors.black.withOpacity(0.1)),
      indicator: const UnderlineTabIndicator(
        borderSide: BorderSide(width: 2.0, color: Color.fromRGBO(27, 83, 243, 1)),
      ),
    ),
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: Colors.white,
      unselectedItemColor: Colors.black,
      selectedItemColor: Color.fromRGBO(27, 83, 243, 1),
